...
// Build test emails, then send to EMAIL
gulp.task('test',
  gulp.series('build', credsTest, aws, mail));
...
function watch() {
  ...
  gulp.watch(['../scss/**/*.scss', 'src/assets/scss/**/*.scss', 'src/data/*', '!src/data/archive/**/*.yml']).on('all', gulp.series(resetPages, sass, pages, inline, browser.reload));
